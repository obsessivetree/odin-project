...
const sortable = new _shopify_draggable__WEBPACK_IMPORTED_MODULE_0__.Sortable(document.querySelectorAll(".list0 ul"), {
  draggable: ".checkbox-li",
  plugins: [_shopify_draggable__WEBPACK_IMPORTED_MODULE_0__.Plugins.Snappable],
  mirror: {
...
document.addEventListener("click", (e) => {
  ...
  if (e.target.classList !== undefined) {
    ...
    if (
      ...
      const listObj = (0,_app__WEBPACK_IMPORTED_MODULE_1__.List)();
      list.classList.add(`list${listObj.id}`);
      document.querySelector("main").appendChild(list);
      list.querySelector("h2").click();
      const sortable = new _shopify_draggable__WEBPACK_IMPORTED_MODULE_0__.Sortable(
    ...
    if (e.target.classList.contains("add-col-btn")) {
      ...
      const newCol = (0,_app__WEBPACK_IMPORTED_MODULE_1__.Collection)();
      newNav.textContent = newCol.name;
      _app__WEBPACK_IMPORTED_MODULE_1__.data[newCol.id] = newCol;
      // console.log(data);
    ...
    input.addEventListener("keydown", (e) => {
      if (e.key === "Enter") {
        if (input.value.trim() !== "") {
          ...
          console.log(thisCol);
          _app__WEBPACK_IMPORTED_MODULE_1__.data[thisCol.slice(thisCol.length - 1)].name = input.value.trim();
          console.table(_app__WEBPACK_IMPORTED_MODULE_1__.data);
        } else {
